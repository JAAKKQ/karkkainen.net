...
I have increasingly started to focus more on cyber security, servers, and networking instead of software development. It all started with building the infrastructure to run the game servers for the Beryllium multiplayer game I developed. Over time, I started running other services on the same servers, and it quickly transformed into a home lab.
